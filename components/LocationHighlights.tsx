    ...
    <section id="location" className="bg-[#efe6d4]">
      <div className="max-w-[1180px] mx-auto px-[clamp(20px,5vw,54px)] py-[clamp(64px,11vh,130px)]">
        ...
        <div className="flex flex-col lg:flex-row gap-[clamp(40px,6vw,80px)] items-start mb-[clamp(44px,7vh,72px)]">
          <div
            ref={eyebrowRef}
            className="flex-1 min-w-0 [.js_&]:opacity-0 [.js_&]:translate-y-[26px] transition-[opacity,transform] duration-[900ms] ease-[cubic-bezier(.2,.8,.2,1)] [.js_&]:data-[visible=true]:opacity-100 [.js_&]:data-[visible=true]:translate-y-0"
          >
          ...
          <div
            ref={photoRef}
            className="w-full lg:w-[clamp(320px,42%,520px)] shrink-0 [.js_&]:opacity-0 [.js_&]:translate-y-[26px] transition-[opacity,transform] duration-[900ms] delay-[150ms] ease-[cubic-bezier(.2,.8,.2,1)] [.js_&]:data-[visible=true]:opacity-100 [.js_&]:data-[visible=true]:translate-y-0"
          >
            <div
